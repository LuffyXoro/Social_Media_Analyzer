...
# Orchestrates the end-to-end pipeline: fetches data, cleans text, runs sentiment inference, and prepares analytics-ready output.
...
def run(video_id):
    ...
    # step - 5 : Convert published_at to datetime and extract date
